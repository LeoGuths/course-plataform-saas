...
import { ArrowLeft, ArrowRight, CreditCard, Info } from 'lucide-react';
import { z } from 'zod';
            ...
            <form className="flex flex-col space-y-4" onSubmit={handleSubmit(onSubmit)}>
                <Alert className="border-blue-200 bg-blue-50">
                    ...
                    <AlertDescription className="text-sm text-blue-900">
                        <span className="font-semibold">Ambiente de testes:</span> Use o
                        cartão{' '}
                        <span className="inline-flex items-center gap-1 font-mono font-semibold bg-blue-100 px-2 py-0.5 rounded">
              <CreditCard className="h-3 w-3" />
              4444 4444 4444 4444
            </span>{' '}
                        com qualquer CVV, data de validade futura e dados fictícios.
                    </AlertDescription>
                </Alert>
